...
Magic Stick fournit 5 scripts dans le repertoire `scripts/` pour builder, flasher, verifier, mettre a jour et installer les logiciels.
...
. Renomme l'ISO en `build/magic_stick_0.1.0.iso`
...
Si aucun fichier n'est specifie, utilise la derniere ISO dans `build/`.
