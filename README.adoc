...
**image:https://img.shields.io/badge/⬇_Download_ISO-v0.1.0-brightgreen[Download v0.1.0]**

* https://github.com/cheroliv/magic_stick/releases/tag/v0.1.0[GitHub Releases] — `.xz` compressed
* https://sourceforge.net/projects/magic-stick/files/[SourceForge] — raw ISO + `.xz`

IMPORTANT: Flash the ISO directly:
[source,bash]
----
# From SourceForge (raw ISO — ready to flash)
sudo dd if=magic_stick_0.1.0.iso of=/dev/sdX bs=4M status=progress && sync

# From GitHub Releases (.xz — decompress first)
...
| ✅ Done — https://github.com/cheroliv/magic_stick/releases/tag/v0.1.0[Download v0.1.0]
