...
**image:https://img.shields.io/badge/⬇_Download_ISO-v0.1.0-brightgreen[Download v0.1.0]** https://github.com/cheroliv/magic_stick/releases/tag/v0.1.0[**Download Magic Stick v0.1.0 ISO (.xz)**]

IMPORTANT: The ISO is distributed as `.xz` (compressed). Flash with:
[source,bash]
----
