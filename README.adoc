...
**image:https://img.shields.io/badge/⬇_Download_ISO-v0.1.8-brightgreen[Download v0.1.8]**
...
| ✅ Done — https://sourceforge.net/projects/magic-stick/files/[Download v0.1.8]
...
CAUTION: Never store credentials in image layers.
[source,bash]
----
...
* The Docker image is CLI-only — no XFCE, no JetBrains Toolbox, no VS Code
